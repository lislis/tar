class Game {
  constructor(midi) {
    ...
    this.bgSound = new Audio('audio/FunkyLoop.wav');
    this.collect = new Audio('audio/325805__wagna__collect.wav');
    this.crash = new Audio('audio/219837__qubodup__glass-drop-4.flac');
    this.bgSound.play();
  }
